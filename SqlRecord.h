...
public:
    ...
    void setIntArray(int index, std::vector<int> value);
...
public:
    ...
    void setIntArray(string fieldName, std::vector<int> value);
...
public:
    ...
    void setIntArray(Field& field, std::vector<int> value);
