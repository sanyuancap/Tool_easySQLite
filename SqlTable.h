...
public:
	...
	bool remove();
	bool truncate();
    bool index(string indexName, string fieldName, bool unique = false);
    bool index(string indexName, std::vector<string> fieldNames, bool unique = false);
...
public:
	...
	bool updateRecord(Record* record, string condition);
